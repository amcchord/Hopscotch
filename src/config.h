...
static constexpr float BALANCE_DRIVE_RATE_K = 1.5f;
static constexpr float BALANCE_DRIVE_SPEED_K = 3.0f;
// Driving needs less phase lag than the original stationary rate filter.
// Actual fresh-sample dt is used; startup/stationary filtering stays unchanged.
static constexpr float BALANCE_DRIVE_RATE_TAU = 0.006f;
static constexpr float BALANCE_DRIVE_ARM_SCALE = 0.30f;
static constexpr float BALANCE_DRIVE_ARM_LIMIT = 0.12f;
static constexpr float BALANCE_DRIVE_ARM_HEADROOM = 3.0f; // 27 of 30 rad/s
static constexpr float BALANCE_DRIVE_ARM_ERROR = 2.0f;
static constexpr float BALANCE_DRIVE_ARM_OUTWARD_RATE = 8.0f;
static constexpr float BALANCE_DRIVE_ARM_CONFIRM_MS = 60.0f;
static constexpr float BALANCE_DRIVE_ARM_SEVERE_ERROR = 8.0f;
static constexpr float BALANCE_DRIVE_ARM_SEVERE_RATE = 20.0f;
