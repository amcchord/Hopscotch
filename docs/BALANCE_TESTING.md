...
[V10](BALANCE_LOWER_V10_2026-09.md) adds CH6-selected fast laydown. Select HIGH
...
Use the current v10 procedure for the next lowering trial; stop further attempts on a fault and retrieve the log.
...
|---|---|
| CH1, CH2, CH4 | Neutral |
| CH6 | HIGH: fast maneuver; LOW/center: normal; selected separately at each CH11 request |
...
speed. V10 retains that normal behavior and adds fast return with CH6 HIGH.
...
procedure](BALANCE_LOWER_V10_2026-09.md) with the established clear-area/spotter
