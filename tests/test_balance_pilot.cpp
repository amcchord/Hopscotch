...
int main() {
    ...
    assert(balance_log::supported(11,240) && balance_log::supported(12,240));
    assert(balance_log::supported(13,240));
    assert(!balance_log::supported(3,240) && !balance_log::supported(14,240));
