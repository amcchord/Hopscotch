...
int main() {
    ...
    std::cout<<"Standing drive checks passed: neutral/calm unlock, bounded motion/reversal, input loss, stop/heading handoff, invalid input, 50000 bounded updates, v2/v3 layout\n";
}
