...
int main() {
    ...
    assert(balance_log::supported(6,240) && balance_log::supported(7,240) && balance_log::supported(8,240) && balance_log::supported(9,240));
    assert(!balance_log::supported(7,236));
    assert(!balance_log::supported(3,240) && !balance_log::supported(10,240));
