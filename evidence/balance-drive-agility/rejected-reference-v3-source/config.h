...
static constexpr float BALANCE_PILOT_VEL_LEAD = 3.0f; // reference lead while accelerating
static constexpr float BALANCE_PILOT_ACCEL_TAU = 0.08f;
static constexpr float BALANCE_PILOT_ACCEL_LEAN = 0.2f; // deg per wheel rad/s^2
static constexpr float BALANCE_PILOT_LEAN_LIMIT = 1.5f;
