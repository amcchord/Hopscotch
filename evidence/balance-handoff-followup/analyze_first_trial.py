...
FILES = [
    ('Previous: hand-assisted', 'bal_20260914_214925_crsf-timing-fix-assisted.csv'),
    ('Feedback fix: hand-assisted', 'bal_20260914_222023_feedback-fix-first.csv'),
]
...
fig.savefig(ROOT / 'evidence/balance-handoff-followup/first-trial-comparison.png', dpi=160)
(ROOT / 'evidence/balance-handoff-followup/first-trial-metrics.json').write_text(json.dumps(metrics, indent=2)+'\n')
