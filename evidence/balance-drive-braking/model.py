...
class Pilot:
 def __init__(self,params,profile,capture=(False,1,2.5,8,60),brake=None,api=lib):
  self.api=api
...
def run(params=None,profile='small',p=plant,duration=36,pushes=None,seed=1,capture=(False,1,2.5,8,60),brake=None):
