...
for A,B,wn,z,delay,sign in itertools.product((8,25,45),(4,7,13,16),(40,60),(.35,.6),(0,.01),(-1,1)):
 ...
 pair={}
 for label,dec,brake in [('v4',8,(0,0,1,4,.08)),('ramp',20,(0,0,1,4,.08)),('boost3',20,(.5,3,1,4,.08)),('boost6',20,(1,6,1,4,.08)),('boost6soft',20,(1,6,2,6,.08))]:
...
print(json.dumps(summary,indent=2),flush=True);(OUT/'mild-boost-screen.json').write_text(json.dumps(dict(summary=summary,cases=rows),indent=2)+'\n')
