...
variants={'baseline':base, **{f'acc{a}':replace(base,arm_return_acceleration=a) for a in (4.,6.,8.,12.,20.)}}
results=[]
...
Path('evidence/balance-standup-fix/screening3.json').write_text(json.dumps(results,indent=2)+'\n')
